...
namespace StevieDev.Dialogue.Editor
{
    public class ChoiceNode : BaseNode
    {
        ...
        public ChoiceNode(Vector2 position, DialogueEditorWindow editorWindow, DialogueGraphView graphView)
        {
            ...
            _nodeGUID = Guid.NewGuid().ToString();               // Set Guid ID
        ...
        private void ChoiceStateEnum()
        {
            ...
            EnumField choiceStateEnumField = GetEnumField_ChoiceStateType(ChoiceData.ChoiceStateTypes, "enumHide");
        ...
        {
            ShowHide(ChoiceData.EventData_StringConditions.Count > 0, _choiceStateEnumBox);
        }
